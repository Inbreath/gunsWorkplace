...
public abstract class WebUtils {
    ...
    private static final String     DEFAULT_CHARSET = MemberConstants.CHARSET_UTF8;
    private static final String     FORMAT_XML      = MemberConstants.FORMAT_XML;
    private static final String     FORMAT_JSON     = MemberConstants.FORMAT_JSON;
     ...
     * @throws IOException
     */
    public static String doPost(String url, String params, int connectTimeout,
            int readTimeout) throws IOException {
        return doPost(url, params, FORMAT_XML ,DEFAULT_CHARSET, connectTimeout, readTimeout);
    }
    ...
    /**
     * 新增 -- jcouyang@chinaums.com
     * 
     * @param url 请求地址
     * @param params 请求参数
     * @param msgType 请求参数类型，如json或者xml
     * @param charset 字符集，如UTF-8, GBK, GB2312
     * @param connectTimeout
     * @param readTimeout
     * @return
     * @throws IOException
     */
    public static String doPost(String url, String params, String msgType, String charset,
            int connectTimeout, int readTimeout) throws IOException {
        String ctype = "application/x-www-form-urlencoded;charset=" + charset;
        if (FORMAT_JSON.equalsIgnoreCase(msgType)) {
            ctype = "application/json;charset=" + charset;
        } else if (FORMAT_XML.equals(msgType)) {
            ctype = "text/xml;charset=" + charset;            
        }
        byte[] content = {};
        if (params != null) {
...
//        conn.setRequestProperty("Accept", "text/json,text/xml,text/javascript,text/html");
