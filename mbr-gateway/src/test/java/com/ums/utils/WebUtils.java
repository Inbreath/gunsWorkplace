...
public abstract class WebUtils {
    ...
    private static final String     DEFAULT_CHARSET = UmisConstants.CHARSET_UTF8;
    private static final String     FORMAT_XML      = UmisConstants.FORMAT_XML;
    private static final String     FORMAT_JSON     = UmisConstants.FORMAT_JSON;
